...
class User_Dashboard_Shortcode {
    ...
    private $defaults = array(
        ...
        'show_stats' => 'true',
        'show_study_materials_sidebar' => 'true', // New: Control entire right sidebar
        'show_account_edit' => 'true', // New: Control account edit section
        'account_edit_as_dropdown' => 'false', // New: Convert to dropdown
        'practice_url' => '', // Empty = use default URLs
        'real_test_url' => '', // Empty = use default URLs
        'study_materials_url' => '', // Empty = use default URLs
        'topic_tests_url' => '', // Empty = use default URLs
        'account_url' => '#',
        'stats_url' => '#',
    ...
    private function get_student_teacher_id() {
        ...
        // DISABLED: Table doesn't exist - skip this query to prevent errors
        $teacher_id = null;
        /*
    ...
    public function render_dashboard($atts) {
                    ...
                    <div class="dashboard-column">
                        ...
                        <div class="test-column">
                            ...
                            <?php if ($atts['show_practice'] === 'true') : ?>
                                <?php 
                                $practice_url = !empty($atts['practice_url']) ? $atts['practice_url'] : home_url('quizzes/מבחן-תרגול-להמחשה/');
                                ?>
                            <a href="<?php echo esc_url($practice_url); ?>" class="dashboard-button practice-button">
                            ...
                            <?php if ($atts['show_real_test'] === 'true') : ?>
                                <?php 
                                $real_test_url = !empty($atts['real_test_url']) ? $atts['real_test_url'] : home_url('/courses/פרטי/lessons/פרק-01-תורת-החינוך-התעברותי-פרק-מבוא/quizzes/מבחן-אמת-כמו-בתאוריה/');
                                ?>
                            <a href="<?php echo esc_url($real_test_url); ?>" class="dashboard-button real-test-button">
                            ...
                            <?php if ($atts['show_teacher_quizzes'] === 'true' && $this->should_show_teacher_quiz()) : ?>
                                ...
                                if ($teacher_id) {
                                    $teacher_quizzes = $this->get_teacher_quizzes($teacher_id, 1);
                        ...
                        <!-- Study Materials Section (if enabled) -->
                        <?php if ($atts['show_study_materials_sidebar'] === 'true' && ($atts['show_study_materials'] === 'true' || $atts['show_topic_tests'] === 'true')) : ?>
                            <div class="questions-column" style="margin-top: 20px;">
                                <div class="column-header">
                                ...
                                <?php if ($atts['show_study_materials'] === 'true') : ?>
                                    <?php 
                                    $study_materials_url = !empty($atts['study_materials_url']) ? $atts['study_materials_url'] : '#';
                                    ?>
                                ...
                                <?php if ($atts['show_topic_tests'] === 'true') : ?>
                                    <?php 
                                    $topic_tests_url = !empty($atts['topic_tests_url']) ? $atts['topic_tests_url'] : '#';
                                    ?>
        ...
        /* Dropdown styles for account edit */
        ...
        .user-action-dropdown.disabled {
            opacity: 0.6;
        }
        
        .account-edit-dropdown {
            flex: 1;
            padding: 8px 12px;
            border: 1px solid #ddd;
            border-radius: 4px;
        ...
        .account-edit-dropdown:disabled {
            background: #f5f5f5;
            color: #666;
            cursor: not-allowed;
        }
